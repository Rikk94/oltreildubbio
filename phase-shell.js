(function(){
  ...
  Object.keys(labels).forEach(function(k){const a=document.createElement('a');a.href=root+labels[k][2];a.textContent='FASE '+labels[k][0]+' · '+labels[k][1];if(k===phase)a.className='active';nav.appendChild(a);});
